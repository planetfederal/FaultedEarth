FaultedEarth = Ext.extend(gxp.Viewer, {
    ...
    constructor: function(config) {
        ...
        var propertyNames = {
            ...
            "u_sm_d_com": "Upper seismogenic depth data completeness factor (1, 2, 3, or 4)",
            ...
            "low_d_com": "Lower seismogenic depth data completeness factor (1, 2, 3, or 4)",
            "strike": "Strike (...\u00B0)",
            "dip_min": "Dip min (...\u00B0)",
            "dip_max": "Dip max (...\u00B0)",
            "dip_pref": "Dip pref (...\u00B0)",
            ...
            "slip_com": "Slip type data completeness factor (1, 2, 3, or 4)",
            "slip_r_min": "Slip rate min (mm/yr)",
            "slip_r_max": "Slip rate max (mm/yr)",
            "slip_r_pre": "Slip rate pref (mm/yr)",
            "slip_r_com": "Slip rate data completeness factor (1, 2, 3, or 4)",
            "aseis_slip": "Aseismic-slip factor (0-1)",
            "aseis_com": "Aseismic-slip factor data completeness factor (1, 2, 3, or 4)",
            ...
            "mov_com": "Age of last movement Data completeness factor (1, 2, 3, or 4)",
